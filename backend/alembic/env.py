...
def get_url():
    """Retorna a URL de conexão com o banco de dados das configurações."""
    print("Database URL: ", settings.database.get_database_url())
    return str(settings.database.get_database_url())
